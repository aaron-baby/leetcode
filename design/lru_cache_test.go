...
func TestLRUCache(t *testing.T) {
	...
	lc.Put(2, 2)
	got := []int{}
	got = append(got, lc.Get(1))

	lc.Put(3, 3)

	got = append(got, lc.Get(2))

	lc.Put(4, 4)
	got = append(got, lc.Get(1))

	got = append(got, lc.Get(3))

	got = append(got, lc.Get(4))
	want := []int{1, -1, -1, 3, 4}
...
func TestLRUCacheCase3(t *testing.T) {
	got := []int{}
	lc := Constructor(2)
	got = append(got, lc.Get(2))
	lc.Put(2, 6)
...
func TestLRUCacheCase4(t *testing.T) {
	got := []int{}
	lc := Constructor(2)
	lc.Put(2, 1)
	lc.Put(3, 2)
...
func TestLRUCacheCase5(t *testing.T) {
	...
	for i := 0; i < len(operations); i++ {
		...
		switch operations[i] {
		case "LRUCache":
			lc = Constructor(params[i][0])
		case "put":
			lc.Put(params[i][0], params[i][1])
		case "get":
			got = append(got, lc.Get(params[i][0]))
		}
	}
...
func TestLRUCacheCase6(t *testing.T) {
